...
async function startWorker() {
  try {
    ...
    console.log(`🛠️  [worker_mul] En attente de messages dans "${inputQueue}"...`);
    ...
    channel.consume(inputQueue, async (msg) => {
      if (msg !== null) {
        ...
        console.log(`✅ [worker_mul] Résultat envoyé après ${waitTime / 1000}s : ${resultMsg.result}`);
        channel.ack(msg);
      }
    }, {
      noAck: false
